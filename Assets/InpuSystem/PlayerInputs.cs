...
public partial class @PlayerInputs : IInputActionCollection2, IDisposable
{
    ...
    private IHammerHitActions m_HammerHitActionsCallbackInterface;
    ...
    public struct HammerHitActions
    {
        ...
        {
            if (m_Wrapper.m_HammerHitActionsCallbackInterface != null)
            {
                @Hammer.started -= m_Wrapper.m_HammerHitActionsCallbackInterface.OnHammer;
                @Hammer.performed -= m_Wrapper.m_HammerHitActionsCallbackInterface.OnHammer;
                @Hammer.canceled -= m_Wrapper.m_HammerHitActionsCallbackInterface.OnHammer;
            }
            m_Wrapper.m_HammerHitActionsCallbackInterface = instance;
            if (instance != null)
            {
